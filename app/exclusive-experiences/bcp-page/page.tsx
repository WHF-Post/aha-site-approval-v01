// app/exclusive-experiences/bcp-page.tsx
import Image from 'next/image';
import bcpLogo from '/public/bcp_logo_heart_white.png';
...
export default function BCPPage() {
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center px-4 pt-24 pb-16">
      <Image src={bcpLogo} alt="BCP Logo" width={400} height={400} className="mb-6" />
      <div className="max-w-4xl text-center space-y-6">
        <h1 className="text-4xl font-bold">Honoring Bryce Christopher Pitts</h1>
        <p>
