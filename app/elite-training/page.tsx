...
const trainingOptions = [
  {
    ...
    description:
      'From Intro to Mastery, our acting classes teach techniques to help you bring characters to life with confidence, charisma, and emotional truth.',
    cta: 'Sign Up',
  },
  {
    title: 'Private Coaching',
    description:
      'Personalized 1:1 sessions focused on role prep, monologue delivery, cold reads, and scene work tailored to your goals.',
    cta: 'Book Now',
  },
];

export default function EliteTrainingPage() {
    ...
    <div className="min-h-screen bg-black text-white flex flex-col justify-between font-sans">
      <main className="flex flex-col items-center justify-center px-4 py-12">
        ...
        <p className="max-w-3xl text-lg text-center mb-12 text-gray-300">
          ...
          in front of the camera or leading from behind it, our elite training programs are designed to
