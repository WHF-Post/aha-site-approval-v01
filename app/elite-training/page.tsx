    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-neutral-800 to-black">
            <main className="px-4 py-16 max-w-5xl mx-auto text-center flex-grow">
                ...
                <div className="flex justify-center mt-16 flex-col items-center gap-8">
                    <a
                        href="https://forms.fillout.com/t/oFkCqDRBKxus"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex flex-col items-center px-10 py-6 bg-neutral-800 text-white font-bold rounded-xl shadow-lg hover:bg-yellow-500 transition text-xl"
                    >
                        On-Camera Training
                    ...
                    >
                        Off-Camera Training
                        <span className="text-base font-normal mt-2">
                            Learn the basics of production from the writers room to the edit suite.
                        </span>
                    </button>
                </div>
                ...
                {showComingSoon && (
                    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
                        <div className="bg-white text-black p-8 rounded-xl max-w-md text-center relative">
                            ...
                            <p className="mb-4">Off-Camera Training will be available soon.</p>
                        </div>
                    </div>
                )}
            </main>
